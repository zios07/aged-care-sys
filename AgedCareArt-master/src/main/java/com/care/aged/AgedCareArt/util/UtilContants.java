package com.care.aged.AgedCareArt.util;
...
public class UtilContants {
    ...
    public static final long EXPIRATION_TIME = 4 * 60 * 60 * 1000 * 1000;
    ...
    public static final String ADMIN_REGISTRATION_URL = "/api/v1/users/register-admin";
    public static final String ROLES_URL = "/api/v1/roles";
